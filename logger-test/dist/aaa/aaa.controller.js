...
let AaaController = AaaController_1 = class AaaController {
    ...
    findAll() {
        this.logger.log('findAll', AaaController_1.name);
...
], AaaController.prototype, "logger", void 0);
__decorate([
    (0, common_1.Post)(),
...
exports.AaaController = AaaController = AaaController_1 = __decorate([
